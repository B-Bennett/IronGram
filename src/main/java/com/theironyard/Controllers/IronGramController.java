...
public class IronGramController {
    ...
    public Photo upload(
        ...
        User recevierUser = users.findOneByUsername(receiver);
        ...
        fos.write(photo.getBytes()); //to save to a file in the public folder


        Photo p = new Photo();
        p.sender = senderUser;
        p.receiver = recevierUser;
    ...
    public List<Photo> showPhotos(HttpSession session) throws Exception {
        ...
        User user = users.findOneByUsername(username); // just an arry of photo objects
